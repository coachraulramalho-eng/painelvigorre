...
interface Acordo {
  ...
  status: string;
  notes: string;
  representative?: { user?: { name: string } };
  company?: { name: string };
}
  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (acordoRes.ok) {
        ...
        setFormData({
          representativeId: data.agreement.representativeId || '',
          companyId: data.agreement.companyId || '',
          service: data.agreement.service || '',
          percentage: data.agreement.percentage ? String(data.agreement.percentage) : '',
          fixedValue: data.agreement.fixedValue ? String(data.agreement.fixedValue) : '',
          calculationBase: data.agreement.calculationBase || 'Valor efetivamente recebido',
          validityStart: data.agreement.validityStart ? new Date(data.agreement.validityStart).toISOString().split('T')[0] : '',
          validityEnd: data.agreement.validityEnd ? new Date(data.agreement.validityEnd).toISOString().split('T')[0] : '',
          status: data.agreement.status || 'Ativo',
